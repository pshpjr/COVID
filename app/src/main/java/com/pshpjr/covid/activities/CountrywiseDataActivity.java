...
import com.pshpjr.covid.data.PerCountryData;
...
public class CountrywiseDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("국가별 정보");
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(CountrywiseDataActivity.this, "데이터 갱신!", Toast.LENGTH_SHORT).show();
            }
        });
