...
public class WorldDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("코로나 현황 (세계)");
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(WorldDataActivity.this, "데이터 갱신됨!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void putData(){
        ...
        PieChart mPieChart = (PieChart) findViewById(R.id.piechart_world);
        mPieChart.addPieSlice(new PieModel(totalActiveInt.intValue(),ContextCompat.getColor(getApplicationContext(), R.color.blue_pie)));
        mPieChart.addPieSlice(new PieModel(totalRecoveredInt.intValue(),ContextCompat.getColor(getApplicationContext(), R.color.green_pie)));
        mPieChart.addPieSlice(new PieModel(totalDeceasedInt.intValue(),ContextCompat.getColor(getApplicationContext(), R.color.red_pie)));
    ...
    public void openCountryData(View view) {
        Intent intent = new Intent(this, com.pshpjr.covid.activities.CountrywiseDataActivity.class);
