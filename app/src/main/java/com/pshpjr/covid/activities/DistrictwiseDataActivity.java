...
import com.pshpjr.covid.adapters.DistrictAdapter;
import com.pshpjr.covid.data.PerDistrictData;
import com.pshpjr.covid.models.DistrictModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(DistrictwiseDataActivity.this, "데이터 갱신됨!", Toast.LENGTH_SHORT).show();
            }
        });
